            ...
            parallel: {
                ...
                stage('Analisis Sonarqube',) {
                    withSonarQubeEnv {
                        ...
                        sh "mvn org.sonarsource.scanner.maven:sonar-maven-plugin:3.6.0.1398:sonar -Dsonar.projectName=\"my_project ${env.BRANCH_NAME}\" -Dsonar.projectKey=honest-corn:master -Pquality_control"
                    }
                }
            }
        }
